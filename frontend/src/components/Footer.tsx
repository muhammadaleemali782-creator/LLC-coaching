...
export const Footer: React.FC = () => {
  const { navigateTo, setIsAdminAuthModalOpen, isAdminLoggedIn } = useApp();
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs font-extrabold text-slate-700">
            <button onClick={() => navigateTo('home')} className="hover:text-[#0066FF] transition-colors">
              Home
            </button>
            <button onClick={() => navigateTo('courses', 'courses-section')} className="hover:text-[#0066FF] transition-colors">
              Courses
            </button>
            <button onClick={() => navigateTo('study-material', 'study-material-section')} className="hover:text-[#0066FF] transition-colors">
              Study Vault
            </button>
            <button onClick={() => navigateTo('batches', 'batches-section')} className="hover:text-[#0066FF] transition-colors">
              Batches
            </button>
            <button onClick={() => navigateTo('notices')} className="hover:text-[#0066FF] transition-colors">
              Notices
            </button>
            <button onClick={() => navigateTo('contact', 'contact-section')} className="hover:text-[#0066FF] transition-colors">
              Contacts
            </button>
            <button onClick={() => navigateTo('student-portal')} className="hover:text-[#0066FF] transition-colors text-[#0066FF]">
              Student Portal
            </button>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 pt-2">
            ...
            <button
              onClick={scrollToTop}
              className="w-10 h-10 rounded-full bg-blue-50 text-[#0066FF] hover:bg-[#0066FF] hover:text-white border border-blue-200 flex items-center justify-center transition-colors shadow-xs"
              title="Back to Top"
            >
        ...
        {/* Bottom Copyright Strip (Ample Padding for Mobile Nav) */}
        <div className="pt-8 border-t border-slate-100 text-center space-y-2">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-[11px] text-slate-400 font-medium">
            ...
            <button
              ...
              className="hover:text-[#0066FF] transition-colors font-bold"
            >
